...
* Hardware Map
*   Motor Controllers:
*       -MCP0 = Motor controller plugged into port 6 of the core power module
*       -MCP1 = Motor controller plugged into port N/A of the core power module
*
*
*   Motors:
*       -MotorFrontL = plugged into motor slot 2 of motor controller 0, front left motor
